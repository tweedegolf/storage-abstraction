...
export declare type GenericKey = number | string | boolean | number[] | string[] | boolean[];
...
export declare type AdapterConfig = ConfigLocal | ConfigAmazonS3 | ConfigGoogleCloud | ConfigBackblazeB2 | ConfigTemplate;
export declare type BackblazeB2Bucket = {
    accountId: "string";
    bucketId: "string";
    bucketInfo: "object";
    bucketName: "string";
...
export declare type BackblazeB2File = {
    accountId: string;
    action: string;
    bucketId: string;
