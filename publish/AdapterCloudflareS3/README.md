...
This adapter provides an abstraction layer over the S3 API of Backblaze B2 cloud storage. It extends `AdapterAmazonS3` and overrides some methods because the implementation of Backblaze is not fully compatible.
