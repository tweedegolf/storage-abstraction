import { S3Client, _Object, ObjectVersion } from "@aws-sdk/client-s3";
...
export declare class AdapterAmazonS3 extends AbstractAdapter {
    ...
    protected getFileVersions(bucketName: string, maxFiles?: number): Promise<{
        value: Array<ObjectVersion> | null;
        error: string | null;
    }>;
